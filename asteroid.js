...
function init() {
	...
	messageField = new createjs.Text("Loading", "bold 24px Arial", acolor);
...
function doneLoading(event) {
	...
	scoreField = new createjs.Text("0", "bold 18px Arial", acolor);
...
function fireBullet() {
	...
	//draw the bullet
	o.graphics.beginStroke(acolor).moveTo(-1, 0).lineTo(1, 0);
